#!/usr/bin/env python3
"""Resume Zeus pipeline from Architect onward — Oracle/Scribe/Voice already cached."""
import sys
import json
...
from status_manager import agent_start, agent_done, agent_error, run_done, run_failed
...
try:
    print("\n[4/6] The Architect — assembling video (resumed)...")
